...
GLuint	HehiList;				// object display list
...
int     WhichViewPoint;     // 0 is outside, 1 is inside
...
//	else
	...
	if (WhichViewPoint != 0)
	{
		gluLookAt(-0.4, 1.8, -4.9, 0.0, 0.0, -10.0, 0.0, 1.0, 0.0);
	}
	else
	{
...
InitLists( )
{
	...
	glutSetWindow( MainWindow );
		...
		HehiList = glGenLists( 1 );
		glNewList( HehiList, GL_COMPILE );
