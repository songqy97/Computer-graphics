...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Qinyuan Song" };
...
const int NUM_PARTICLES = 4096*1024;
...
InitLists( )
{
	...
	// ****************************************
	// Green Sphere
		glColor3f(0., 1., 0.);	// 0. <= r,g,b <= 1.
		glPushMatrix();
		glTranslatef(700.f, -800.f, 600.f);
