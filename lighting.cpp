...
Display( )
{
	...
	// Red & moving point light
	glPushMatrix();
	glTranslatef(-3., 0., 9. - BoxTime * 10.);
	SetMaterial(1., 0., 0., 100.);
	glutSolidSphere(0.2, 20, 20);
	glPopMatrix();
	SetPointLight(GL_LIGHT0, -3., 0., 9. - BoxTime * 10., 1., 0., 0.);
	...
	glutSolidSphere(0.2, 20, 20);
	glPopMatrix();
	SetSpotLight(GL_LIGHT1, 0., 0., -3., 3., 0., 3., 1., 1., 1.);

	// Blue point light
	glPushMatrix();
	glTranslatef(7., 0., 0.);
	SetMaterial(0., 0., 1., 100.0);
	glutSolidSphere(0.2, 20, 20);
	glPopMatrix();
	SetPointLight(GL_LIGHT2, 7., 0., 0., 0., 0., 1.);
	...
	glTranslatef(-3., 0., 10. - BoxTime * 10);
	SetMaterial(1., 1., 0., 100.);
	glCallList( BoxList );
	glPopAttrib();
	glPopMatrix();

	// Magenta shiny sphere
	glPushMatrix();
	glPushAttrib(GL_LIGHTING_BIT);
	glShadeModel(GL_FLAT);
	glTranslatef(3., 2., 0);
	SetMaterial(1., 0., 1., 100.);
